...
import type { ManualConfig, ManualConfigHistoryEntry } from '@/lib/pdf/manualConfig';
import { serializeConfig, serializeHistory } from '@/lib/pdf/manualConfig';
...
export async function updateProjetFields(slug: string, fields: ProjetEditableFields): Promise<{ slug: string }> {
  ...
  if (fields.savedManualConfig !== undefined)
    update['fldBHee96Nsn8rkWx'] = serializeConfig(fields.savedManualConfig);
